...
use App\includes\XMPPHP_XMLStream;
...
class XMPPHP_XMPP extends \XMPPHP_XMLStream {
	 ...
	 */
	public function __construct($host, $port, $user, $password, $resource, $server = null, $printlog = false) {
		parent::__construct($host, $port, $printlog);
